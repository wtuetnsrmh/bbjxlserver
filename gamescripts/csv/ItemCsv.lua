...
function ItemCsvData:calItemId(itemInfo)
	local idFunc = {
		[ItemTypeId.Gift] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.GoldCoin] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.Yuanbao] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.Health] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.PvpCount] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.SpecialBattleCount] = function(itemId) return itemInfo.itemId end,
		...
		[ItemTypeId.Skill] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.Lingpai] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.StarSoul] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.HeroSoul] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.HeroEvolution] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.Beauty] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.Package] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.RandomFragmentBox] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.RandomItemBox] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.ZhanGong] = function(itemId) return itemInfo.itemId end,
		[ItemTypeId.SkillLevel] = function(itemId) return itemInfo.itemId end,
	...
	if itemInfo.itemTypeId and idFunc[itemInfo.itemTypeId] then
		return idFunc[itemInfo.itemTypeId](itemInfo.itemId)
	else
